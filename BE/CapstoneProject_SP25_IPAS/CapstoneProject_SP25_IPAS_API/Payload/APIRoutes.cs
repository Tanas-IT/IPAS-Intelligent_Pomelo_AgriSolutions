...
namespace CapstoneProject_SP25_IPAS_API.Payload
{
    public static class APIRoutes
    {
        ...
        public static class Criteria
        {
            ...
            public const string exportCSVObject = prefix + "/export-csv/object";
        ...
        public static class Process
        {
            ...
            public const string createProcessWithAI = Base + "/proceesses/create-with-AI";
        }
        ...
        public static class WorkLog
        {
            ...
            public const string NoteForWorkLogUseFile = prefix + "/take-note-with-file";
        ...
        public static class GraftedPlant
        {
            ...
            public const string exportGraftedNoteCSV = graftedNotePrefix + "/export-csv";
