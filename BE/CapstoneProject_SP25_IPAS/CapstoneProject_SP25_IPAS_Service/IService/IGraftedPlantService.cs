...
namespace CapstoneProject_SP25_IPAS_Service.IService
{
    public interface IGraftedPlantService
    {
        ...
        public Task<BusinessResult> getAllGraftedByPlantSumary(GetGraftedByPlantRequest getRequest, PaginationParameter paginationParameter);
        public Task<BusinessResult> getGraftedByIdAsync(int graftedPlantId);
        public Task<BusinessResult> getGraftedByPlant(GetGraftedByPlantRequest getRequest, PaginationParameter paginationParameter);
        ...
        public Task<BusinessResult> ExportGrafted(GetGraftedPaginRequest request);
