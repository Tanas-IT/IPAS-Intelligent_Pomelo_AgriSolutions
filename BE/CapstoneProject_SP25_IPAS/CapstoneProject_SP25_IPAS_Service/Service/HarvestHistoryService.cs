        ...
        private void ApplySorting(ref Func<IQueryable<HarvestHistory>, IOrderedQueryable<HarvestHistory>> orderBy, string? sortBy, string? direction)
        {
            ...
            switch (sortBy)
            {
                ...
                case "yieldhasrecord":
                    ...
                    break;
                default:
                    orderBy = isDescending ? (x => x.OrderByDescending(o => o.DateHarvest).ThenByDescending(x => x.HarvestHistoryId))
                                           : (x => x.OrderBy(o => o.DateHarvest).ThenByDescending(x => x.HarvestHistoryId));
                    break;
            }
        }
