...
const alerts = [
  { id: 1, message: 'Severe weather warning: Heavy rain and strong winds expected in your area.', action: 'View Details', route: ROUTE_NAMES.MAIN.MAIN_TABS },
  { id: 2, message: 'Strong winds and possible flooding in your area.', action: 'Manage Tasks', route: ROUTE_NAMES.MAIN.MAIN_TABS },
];
      ...
      {alerts.length > 0 && (
        <View style={styles.section}>
          ...
          {alerts.map((alert) => (
            ...
            >
              <TextCustom style={styles.alertMessage}>{alert.message}</TextCustom>
            </TouchableOpacity>
          ))}
        </View>
      )}
        ...
        >
          <View style={styles.dashboardRow}>
            <View style={styles.dashboardItem}>
              <TextCustom style={styles.dashboardValue}>{farmOverview.totalTrees}</TextCustom>
              <TextCustom style={styles.dashboardLabel}>Total Trees</TextCustom>
            </View>
            <View style={styles.dashboardItem}>
              <TextCustom style={styles.dashboardValue}>{farmOverview.totalYield}</TextCustom>
          ...
          <View style={styles.chartContainer}>
            <PieChart
              data={[
                { name: 'Healthy', population: farmOverview.healthyTrees, color: theme.colors.btnYellow, legendFontColor: '#FFFFFF', legendFontSize: 14 },
                { name: 'Unhealthy', population: farmOverview.diseasedTrees, color: '#FF6F61', legendFontColor: '#FFFFFF', legendFontSize: 14 },
              ]}
