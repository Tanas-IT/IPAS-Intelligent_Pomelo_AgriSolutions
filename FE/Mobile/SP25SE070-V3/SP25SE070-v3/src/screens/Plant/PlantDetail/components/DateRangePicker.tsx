...
const DateRangePicker: React.FC<DateRangePickerProps> = ({
  ...
  const renderPicker = () => {
    ...
    const value = activePicker === 'start' 
      ? (startDate || new Date())
      : (endDate || new Date());
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        style={[styles.dateButton, activePicker === 'start' && styles.activeButton]}
      ...
      <TouchableOpacity
        style={[styles.dateButton, activePicker === 'end' && styles.activeButton]}
