...
import { TextCustom, CustomIcon, AvatarImage } from "@/components";
              ...
              <View style={styles.titleContainer}>
                ...
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        statusConfig[getStatusFromReport(report)].color,
                    },
                  ]}
                >
                  <CustomIcon
                    name={
                      statusConfig[getStatusFromReport(report)]?.icon ||
                      "help-circle"
                    }
                    size={16}
                    color="white"
