...
const statusStyles: Record<StatusType, { backgroundColor: string; textColor: string; borderColor: string }> = {
  ...
  redo: { backgroundColor: '#FFCCBC', textColor: '#D84315', borderColor: '#D84315' },
  onRedo: { backgroundColor: '#FFAB91', textColor: '#BF360C', borderColor: '#BF360C' },
  cancelled: { backgroundColor: '#CFD8DC', textColor: '#455A64', borderColor: '#455A64' },
};
