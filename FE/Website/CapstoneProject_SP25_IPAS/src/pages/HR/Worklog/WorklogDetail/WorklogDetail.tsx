  ...
  return (
    <div className={style.container}>
      ...
      <Flex className={style.contentSectionTitleLeft}>
        ...
        <Tag className={`${style.statusTag} ${style.normal}`}>
          {worklogDetail?.status || "Pending"}
        </Tag>
      </Flex>
      ...
      <Flex vertical gap={10} className={style.contentSectionUser}>
        <Flex vertical={false} gap={15}>
          <Image
            src={worklogDetail?.reporter[0]?.avatar || Images.avatar}
            width={25}
            className={style.avt}
            crossOrigin="anonymous"
          />
          <label className={style.createdBy}>
            {worklogDetail?.reporter[0]?.fullName || "laggg"}
          </label>
        ...
        <Flex gap={15}>
          ...
          <Image
            src={worklogDetail?.listEmployee[0]?.avatar || Images.avatar}
            width={25}
            className={style.avt}
            crossOrigin="anonymous"
          />
          <label className={style.createdBy}>
            {worklogDetail?.listEmployee[0]?.fullName || "Jane Smith"}
          </label>
        </Flex>
        <Flex gap={15}>
