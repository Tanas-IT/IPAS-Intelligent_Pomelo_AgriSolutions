...
export const planColumns: TableColumn<GetPlan>[] = [
  ...
  },
  {
    header: "Process Type",
    field: "processType",
    accessor: (plan) => <TableCell value={plan.processType} />,
    width: 250,
  },
  {
    header: "Plan Detail",
  ...
  },
  {
    ...
    field: "createDate",
    accessor: (plan) => (
      <TableCell value={plan.createDate ? new Date(plan.createDate).toLocaleDateString() : "N/A"} />
    ),
    width: 150,
  },
  {
    ...
    field: "startDate",
    accessor: (plan) => (
      <TableCell value={plan.createDate ? new Date(plan.startDate).toLocaleDateString() : "N/A"} />
    ),
    width: 150,
  },
  {
    ...
    field: "endDate",
    accessor: (plan) => (
      <TableCell value={plan.createDate ? new Date(plan.endDate).toLocaleDateString() : "N/A"} />
    ),
    width: 150,
  },
  {
