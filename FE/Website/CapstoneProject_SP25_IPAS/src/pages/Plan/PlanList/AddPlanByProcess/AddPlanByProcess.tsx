...
// import { Plan, PlanRequest, SubProcess } from "@/payloads";
...
//     const extractPlansFromSubProcesses = (
...
//           const currentPath = parentPath ? `${parentPath} / ${subProcess.subProcessName}` : subProcess.subProcessName;
//           const plans = subProcess.plans.map((plan: Plan) => {
...
//               subProcessPath: currentPath,
//               isSubProcess: true,
//               depth: Math.min(depth, 2), // Giới hạn indent tối đa
//             };
//           });

//           // Đệ quy với children
//           const childPlans = extractPlansFromSubProcesses(
//             subProcess.children,
//             selectedPlanMap,
//             currentPath,
//             depth + 1,
...
//             try {
//               const res = await planService.getPlanByProcessId(selectedProcess.processId);
//               if (res.statusCode === 200 && res.data) {
//                 const { processName, plans, subProcesses } = res.data;

//                 // Lấy plans từ selectedProcess
//                 const mainListPlan = selectedProcess.listPlanIsSampleTrue || [];
...
//                 // Map main plans
//                 const mainPlans = plans.map((plan: Plan) => {
//                   const selectedPlan = combinedListPlan.find(p => p.planId === plan.planId) || {};
//                   return {
//                     planId: plan.planId,
//                     planName: plan.planName,
//                     planDetail: plan.planDetail || "",
...
//                     subProcessOrder: null,
//                     isSubProcess: false,
//                   };
//                 });

//                 // Map sub-process plans
//                 const subProcessPlans = subProcesses?.flatMap(subProcess =>
//                   subProcess.plans.map((plan: Plan) => {
//                     const selectedPlan = combinedListPlan.find(p => p.planId === plan.planId) || {};
//                     return {
//                       planId: plan.planId,
//                       planName: plan.planName,
...
//                       subProcessId: subProcess.subProcessID,
//                       subProcessName: subProcess.subProcessName,
//                       subProcessOrder: subProcess.order,
//                       isSubProcess: true,
//                     };
//                   })
//                 ) || [];

//                 const newDataSource = [...mainPlans, ...subProcessPlans];
...
const AddPlanByProcess = () => {
    ...
    useEffect(() => {
        if (dataSource && dataSource.length > 0) {
            ...
            console.log("Initial Plan Details Form Values:", initialValues);
            planDetailsForm.setFieldsValue(initialValues);
        }
    }, [dataSource, planDetailsForm]);
